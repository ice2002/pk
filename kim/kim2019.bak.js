...
$.setBackground = function()
{
    ...
    img.onload = function ()
    {
        document.body.style.backgroundImage="url("+ aImg[aImg.index] +")";
        //$("body").css("background-image", "url("+ aImg[aImg.index] +")");
        //$('body').attr('style', 'background-image: url("' + aImg[aImg.index] +'")');
    }
}
